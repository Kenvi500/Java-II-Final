...
public interface SAHIPlus<T extends Comparable<T>> extends SortableArrayHolderInterface<T>, searchSort.SearchEnum
{
    ...
    /**
     * The hashing search algorithm, which searches for an element through hashing
     * @param element the element whose subscript is to be found in this ArrayHolder
     * @return the current subscript to the first "element" found in this ArrayHolder, or -1 indicating no such value was found
     */
